...
export class Medicine extends React.Component {
    ...
    componentDidMount() {
        ...
        if(medicineID){
            axios.get('http://localhost:8762/medicine/id/' + medicineID)
                .then(response =>{
    ...
    updateMedicine = event => {
        ...
        axios.put("http://localhost:8762/medicine/update/"+this.state.id,MedicineConstant)
            .then(response=>{
                if(response.data != null){
                    alert("Updated!");
                }
    ...
    submitMedicine = event => {
        ...
        axios.post("http://localhost:8762/medicine/post/",MedicineConstant)
            .then(response=>{
                if(response.data != null){
